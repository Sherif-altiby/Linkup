...
export default async function MessagesPage({
  ...
  return (
    <div className="flex bg-gray-950 text-gray-100 h-[calc(100vh-70px)] overflow-hidden">
      <aside className="w-72 shrink-0 lg:flex flex-col bg-gray-900 border-r border-gray-800 hidden ">
        <MessageSearch />
        <div className="flex-1 overflow-y-auto px-2 py-1 custom-scroll">
          <UserCard />
        </div>
      </aside>
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 flex flex-col gap-3 custom-scroll">
          <UserMessage receiverId={id} />
        </div>
